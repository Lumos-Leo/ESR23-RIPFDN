...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        from models.team23_RIPFDN import RIPFDN
        name, data_range = f"{model_id:02}_RIPFDN", 1
        model_path = os.path.join('model_zoo', 'team23_RIPFDN.pth')
        model = RIPFDN()
        ckpt = torch.load(model_path)['params']
